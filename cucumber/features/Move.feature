Feature: Move a course instance from day+time to another
	...
	Scenario: MBB 314 is free certain times
		...
		Then building "MBB" room "314" is free "0800-0850,1100-1150,1200-1250,1300-1350,1500-1550,1600-1650," during semester "201510" on days "MWF" for 50 minutes
	...
	Scenario: students (list) can attend course at time in room
		...
		And building "MBB" room "314" is free "0800-0850,1100-1150,1200-1250,1300-1350,1500-1550,1600-1650," during semester "201510" on days "MWF" for 50 minutes
